...
class MetaConformer(nn.Module): 
    ...
    def forward_for_export(
        ...
        for lth, layer in enumerate(self.layers):
            ...
            self.meta_learning_layers.get_targets(x = audio_signal[:o_B], layer = lth)
...
class MetaLayer(nn.Module):
    def __init__(
        ...
        #     nn.AvgPool1d(kernel_size=pooling, stride=1),
        #     Rearrange('b c t -> b t c')
        # ) if pooling != -1 else nn.Identity()
