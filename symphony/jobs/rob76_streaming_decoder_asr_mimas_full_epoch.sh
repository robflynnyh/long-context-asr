...
CHECKPOINT_DIR="${ROB76_CHECKPOINT_DIR:-/store/store5/data/acp21rjf/spotify/streaming_decoder_asr_100m_two_head_mimas_full_epoch_${RUN_ID}}"
WANDB_DIR="${ROB76_WANDB_DIR:-$ARTIFACT_ROOT/wandb}"
WANDB_NAME="${ROB76_WANDB_NAME:-streaming_decoder_asr_100m_two_head_mimas_full_epoch}"
