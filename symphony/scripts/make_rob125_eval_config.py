...
def main():
    ...
    for run in manifest["runs"]:
        ...
        models.append(
            {
                "name": f"rob125_{run['label']}_supervised_weighted_bilstm_ctc_probe",
                "label": run["label"],
                ...
                "source_supervised_checkpoint": run["source_checkpoint"],
                "local_supervised_checkpoint": run["local_checkpoint"],
                "known_good_evidence": run.get("known_good_evidence"),
