...
Do not store credentials, raw data, checkpoints, large logs, or generated artifacts here. Put large non-commit files under parscratch and reference their paths.
