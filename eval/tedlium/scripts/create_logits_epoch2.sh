...
for SPLIT in "${SPLITS[@]}"
do
    python create_logits.py -c /mnt/parscratch/users/acp21rjf/spotify/checkpoints_multi_epoch/n_seq_sched_8192_rp_1/step_105360.pt  -s "/mnt/parscratch/users/acp21rjf/spotify/logits/tedlium/epoch_2_n_seq_sched_8192_rp_1_${SPLIT}.pt" --split "${SPLIT}" --overlap 7168 -seq 8192
done
