...
@ray.remote(num_gpus=0.0, num_cpus=0.2)
...
if __name__ == '__main__':
    ...
    parser.add_argument('-max_len', '--max_len', type=int, default=512, help='max sequence length')
    parser.add_argument('-alpha', '--alpha', type=float, default=0.21, help='alpha for beam search')
    parser.add_argument('-beta', '--beta', type=float, default=1.28, help='beta for beam search')
    parser.add_argument('-p', '--p', type=float, default=2.52, help='p for beam search')
