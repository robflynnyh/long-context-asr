...
python create.py --condition_on "earnings22" -d "earnings22" --save_path "/mnt/parscratch/users/acp21rjf/synthetic_e22_conditionede22_test" -c "/mnt/parscratch/users/acp21rjf/spotify/checkpoints_seq_scheduler_rb/n_seq_sched_360000_rp_1/step_105360.pt"
