...
python create.py -d "tedlium" --save_path "/mnt/parscratch/users/acp21rjf/synthetic_tedlium_test" -c "/mnt/parscratch/users/acp21rjf/spotify/checkpoints_seq_scheduler_rb/n_seq_sched_360000_rp_1/step_105360.pt"
