...
python create.py -d "this_american_life" --save_path "/mnt/parscratch/users/acp21rjf/synthetic_TAL_test" -c "/mnt/parscratch/users/acp21rjf/spotify/checkpoints_seq_scheduler_rb/n_seq_sched_360000_rp_1/step_105360.pt"
