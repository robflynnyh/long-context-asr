    ...
    do
        ...
        do
            ...
            do  
                ...
                python run.py -c /mnt/parscratch/users/acp21rjf/spotify/checkpoints_seq_scheduler_rotarybase/n_seq_sched_${SEQ_LEN}_rp_${REPEAT}/step_105360.pt  -log "./logs/rotary_freq_test_${SEQ_LEN}_${SPLIT}.log" --split "${SPLIT}" -overlap ${OVERLAP} -seq ${SEQ_LEN} 
